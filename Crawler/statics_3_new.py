...
import numpy as np
import database
from draw import draw_bar, draw_barh, draw_line, draw_twinx
...
def s_3_1_3():
    ...
    # libraries = read_json(new_data_dir + "/datas/libraries.txt")
    # usage_count = []
    ...
    keys[23] = '80-100'
    keys[24] = '>100'
    usage_count = read_json(new_data_dir + "datas/s_3_1_3.txt")
    count = 0
    for num in usage_count:
        if num > 100:
            values[24] += 1
...
def s_3_1_4_1():
    ...
    # print(usage_count)
    # write_json(new_data_dir + "datas/s_3_1_4.1.txt", usage_count)
    ...
    keys[24] = '35-40'
    keys[25] = '>40'
    usage_count = read_json(new_data_dir + "datas/s_3_1_4.1.txt")
    print(len(usage_count))
    count = 0
    for num in usage_count:
        if num > 40:
...
def s_3_1_4_2():
    ...
    # print(usage_count)
    # write_json(new_data_dir + "datas/s_3_1_4.2.txt", usage_count)

    usage_count = read_json(new_data_dir + "datas/s_3_1_4.2.txt")
    print(len(usage_count))
...
def s_3_1_5():
    ...
    #     usage_count.append(usage_info[0][0])
    # print(usage_count)
    # write_json(new_data_dir + "datas/s_3_1_5.txt", usage_count)
    ...
    keys[24] = '250-300'
    keys[25] = '>300'
    usage_count = read_json(new_data_dir + "datas/s_3_1_5.txt")
    print(len(usage_count))
    count = 0
    for num in usage_count:
        if num > 300:
...
def s_3_1_6():
    ...
    sorted_usage = [('JUnit', 622), ('SLF4J API Module', 358), ('Guava: Google Core Libraries For Java', 278),
     ('Mockito Core', 272), ('Apache Commons IO', 222),
     ('Jackson Databind', 220), ('Apache Commons Lang', 187),
     ('Logback Classic Module', 168), ('Apache HttpClient', 150),
     ('Java Servlet API', 149), ('Apache Log4j', 147), ('AssertJ Fluent Assertions', 133),
     ('Gson', 132), ('Jackson Core', 130),
     ('SLF4J LOG4J 12 Binding', 129), ('Apache Commons Codec', 120), ('Hamcrest Library', 114),
     ('Spring TestContext Framework', 114), ('Commons Lang', 113), ('Joda Time', 113)]
...
def s_3_2_1():
    ...
    keys[28] = '70-80'
    keys[29] = '80-90'
    usage_count = read_json(new_data_dir + "datas/s_3_2_1.txt")
    print(len(usage_count))
    count = 0
    for num in usage_count:
...
def s_3_2_3():
    ...
    keys[28] = '80-90'
    keys[29] = '90-100'
    usage_count = read_json(new_data_dir + "datas/s_3_2_3.txt")
    print(len(usage_count))
    count = 0
    for num in usage_count:
        if num > 90 and num <= 100:
...
def outdateness():
    ...
    download_time = read_json(new_data_dir + "download_time.json")
    sql = "SELECT * FROM project_lib_usage_o"
    query_result = database.querydb(db, sql)
    ...
    for entry in query_result:
        ...
        sql = "UPDATE project_lib_usage_o SET outdate = " + str(count_result[0][0]) + " WHERE project_id = " + str(project_id) + " and version_type_id = " + str(type_id) + " and module = '" + module + "'"
        database.execute_sql(db, sql)
        # break

def s_3_3_1():
    # sql = "SELECT distinct version_id FROM project_lib_usage_other"
    # query_result = database.querydb(db, sql)
    # for entry in query_result:
    #     version_id = entry[0]
    #     sql = "SELECT distinct outdate FROM project_lib_usage_other where version_id = " + str(version_id)
    #     o_result = database.querydb(db, sql)
    #     if len(o_result) > 1:
    #         print(version_id)
    ...
    # for id in projs_3_month:
    #     print(id)
    #     sql = "SELECT outdate,version_id FROM project_lib_usage WHERE project_id = " + str(id)
    #     usage_info = database.querydb(db, sql)
    #     if len(usage_info) <= 0:
    #         continue
    #     total = 0
    ...
    #     for entry in usage_info:
    #         version_id = entry[1]
    #         sql = "SELECT group_str,name_str,repository FROM library_versions WHERE id = " + str(version_id)
    #         version_info = database.querydb(db, sql)
    #         groupId = version_info[0][0]
    #         artifactId = version_info[0][1]
    #         repository = version_info[0][2]
    #         sql = "SELECT count(*) FROM library_versions WHERE group_str = '" + groupId + "' and name_str = '" + artifactId + "' and repository = '" + repository + "' and parsed_date < '" + download_time[str(id)] + "'"
    #         count_result = database.querydb(db, sql)[0][0]
    #         if count_result != 0:
    #             length += 1
    #             total += entry[0]/count_result
    #     usage_count[str(id)] = total/length * 100
    #     # print(total/len(usage_info))
    #     # break
    # # usage_count.sort()
    # print(usage_count)
    # print(len(usage_count))
    # write_json(new_data_dir + "datas/s_3_3_1_data.txt", usage_count)
    ...
    #         total += entry[0]
    #     # usage_count[str(id)] = total / length * 100
    #     usage_count[str(id)] = total/len(usage_info)
    #     # print(total/len(usage_info))
    #     # break
    # # usage_count.sort()
    # print(usage_count)
    ...
    keys[29] = '80-90'
    keys[30] = '90-100'
    usage_count = read_json(new_data_dir + "datas/s_3_3_1_percent_new.txt")
    print(len(usage_count))
    count = 0
    for num in usage_count:
        if num > 90 and num <= 100:
            ...
            index += 1
            values[index] += 1
    draw_bar(keys, values, "The Average Usage Outdatedness of the Library Dependencies in a Project (%)",
    ...
    # keys[28] = '80-90'
    # keys[29] = '90-100'
    # usage_count = read_json(new_data_dir + "datas/s_3_3_1_data.txt")
    # print(len(usage_count))
    # for project_id in usage_count:
    #     num = usage_count[project_id]
    #     size = proj_size[project_id]
    #     if num > 90 and num <= 100:
    #         values[29] += 1
    #         sizes[29].append(size)
    #     elif num > 80 and num <= 90:
    #         values[28] += 1
    #         sizes[28].append(size)
    #     elif num > 70 and num <= 80:
    #         values[27] += 1
    #         sizes[27].append(size)
    #     elif num > 60 and num <= 70:
    #         values[26] += 1
    #         sizes[26].append(size)
    #     elif num > 50 and num <= 60:
    #         values[25] += 1
    #         sizes[25].append(size)
    #     # elif num == 0:
    #     #     values[0] += 1
    #     else:
    #         index = num // 2
    ...
    #     # print(entry)
    #     # print(np.mean(entry))
    #     new_sizes.append(np.median(entry) / 1000)
    #
    # draw_twinx(keys, values, new_sizes, "The Average Usage Outdatedness of the Library Dependencies in a Project (%)",
    #          "The Number of Projects (#)", "The Median Size of Projects (KLOC)")
    ...
    #         values[31] += 1
    #         sizes[31].append(size)
    #     elif num > 90 and num <= 100:
    #         values[30] += 1
    #         sizes[30].append(size)
    #     elif num > 80 and num <= 90:
    #         values[29] += 1
    #         sizes[29].append(size)
    #     elif num > 70 and num <= 80:
    ...
    #     # print(np.mean(entry))
    #     new_sizes.append(np.median(entry) / 1000)
    #     # new_sizes.append(np.mean(entry) / 1000)
    #
    # draw_twinx(keys, values, new_sizes,
    #            "The Average Usage Outdatedness of the Library Dependencies in a Project (#)",
    #            "The Number of Projects (#)", "The Median Size of Projects (KLOC)")
...
def s_3_3_3 ():
    # # nine_month = read_json("D:/data/data_copy/figure/datas/three_month.txt")
    # libraries = read_json(new_data_dir + "library_ids.txt")
    # # print(len(libraries))
    # usage_count = {}
    # for id in libraries:
    #     print(id)
    ...
    #             length += 1
    #     if length > 0:
    #         usage_count[str(id)] = total/length
    # # usage_count.sort()
    # print(usage_count)
    # print(len(usage_count))
    # write_json(new_data_dir + "datas/s_3_3_3_data.txt", usage_count)
    ...
    # for id in libraries:
    #     print(id)
    #     sql = "SELECT project_id,outdate,version_id FROM project_lib_usage WHERE library_id = " + str(id)
    #     usage_info = database.querydb(db, sql)
    #     total = 0
    #     length = 0
    #     for entry in usage_info:
    ...
    #             artifactId = version_info[0][1]
    #             repository = version_info[0][2]
    #             sql = "SELECT count(*) FROM library_versions WHERE group_str = '" + groupId + "' and name_str = '" + artifactId + "' and repository = '" + repository + "' and parsed_date < '" + \
    #                   download_time[str(project_id)] + "'"
    #             count_result = database.querydb(db, sql)[0][0]
    #             if count_result != 0:
    #                 total += entry[1] / count_result
    #                 length += 1
    #     if length > 0:
    #         usage_count[str(id)] = total / length * 100
    # print(usage_count)
    ...
    # keys[29] = '80-90'
    # keys[30] = '90-100'
    # usage_count = read_json(new_data_dir + "datas/s_3_3_3_precent_data.txt").values()
    # print(len(usage_count))
    # count = 0
    # for num in usage_count:
    #     if num > 90 and num <= 100:
    ...
    #
    # values[0] += 64
    # draw_bar(keys, values, "The Average Usage Outdatedness of the Library Dependencies on a Library (%)",
    ...
    # print(usage_count)
    # print(len(usage_count))
    # write_json(new_data_dir + "datas/s_3_3_3.txt", usage_count)
    ...
    keys[31] = '100-300'
    keys[32] = '300-2240'
    usage_count = read_json(new_data_dir + "datas/s_3_3_3.txt")
    print(len(usage_count))
    count = 0
    for num in usage_count:
        if num > 300 and num <= 2240:
...
def n_3_1_1():
    ...
    # for id in projs_3_month:
    #     # print(id)
    #     sql = "SELECT count(DISTINCT group_str,name_str) FROM `usage` WHERE project_id = " + str(id)
    #     usage_info = database.querydb(db, sql)
    #     usage_count[str(id)] = usage_info[0][0]
    #     # usage_count.append(usage_info[0][0])
    # # usage_count.sort()
    # print(len(usage_count))
    # write_json("E:/data/ASE2019/datas/n_3_1_1_data.txt", usage_count)

    proj_size = read_json("E:/data/ASE2019/proj_size.txt")
    keys = ['']*25
    values = [0]*25
    sizes = [[] for i in range(25)]
    keys[0] = '0'
    # values[0] = 1329 - 1281
    for i in range(0,20):
        start = i*5
    ...
    keys[23] = '200-250'
    keys[24] = '>250'
    usage_count = read_json("E:/data/ASE2019/datas/n_3_1_1_data.txt")
    print(len(usage_count))
    for project_id in usage_count:
        size = proj_size[project_id]
        num = usage_count[project_id]
        if num == 0:
            ...
            values[24] += 1
            sizes[24].append(size)
        elif num > 200 and num <= 250:
            values[23] += 1
            sizes[23].append(size)
        elif num > 150 and num <= 200:
            values[22] += 1
            sizes[22].append(size)
        elif num > 100 and num <= 150:
            values[21] += 1
            sizes[21].append(size)
        else:
            index = num // 5 + 1
            if num % 5 == 0:
                index -= 1
    ...
    draw_twinx(keys, values, new_sizes, "The Number of Libraries Used in a Project (#)", "The Number of Projects (#)", "The Median Size of Projects (KLOC)")
...
def n_3_1_3():
    ...
    #     sql = "SELECT distinct group_str,name_str FROM `usage` where project_id = " + str(id)
    #     query_result = database.querydb(db, sql)
    #     libraries = set(query_result)
    #     total = total.union(libraries)
    # print(len(total))
    # # print(libraries)
    # write_json(new_data_dir + "/datas/libraries.txt", list(total))
    ...
    #     for entry in usage_info:
    #         proj_id = entry[0]
    #         if proj_id in projs_3_month:
    #             length += 1
    #     print(str(len(usage_info)) + " " + str(length))
    #     usage_count.append(length)
    # write_json(new_data_dir + "datas/s_3_1_3.txt", usage_count)
    ...
    for entry in libraries:
        ...
        for entry in usage_info:
            ...
            if proj_id in projs_3_month:
                length += 1
        print(str(len(usage_info)) + " " + str(length))
        usage_count[groupId + "__fdse__" + artifactId] = length
        # usage_count.append(length)
    write_json(new_data_dir + "datas/s_3_1_3_data.txt", usage_count)

def n_3_2_1():
    # for id in projs_3_month:
    #     if not os.path.exists(new_data_dir + "project_percent/" + str(id) + ".txt"):
    #         print(id)
    # percent_count = {}
    # count = 0
    # dir = new_data_dir + "project_percent"
    # files = os.listdir(dir)
    # for file in files:
    #     print("++++++++++++" + file)
    #     project_id = int(file.replace(".txt", ""))
    #     if project_id not in projs_3_month:
    #         continue
    #     counts = read_json(os.path.join(dir, file))
    #     if counts[0] == 0:
    #         print("counts[0] == 0")
    ...
    #         continue
    #     # percent_count.append(counts[1] / counts[0] * 100)
    #     percent_count[str(project_id)] = counts[1] / counts[0] * 100
    # # percent_count.sort()
    # print(percent_count)
    # print(len(percent_count))
    # print(count)
    # write_json(new_data_dir + "datas/s_3_2_1_data.txt", percent_count)

    proj_size = read_json("E:/data/ASE2019/datas/n_3_1_1_data.txt")
    keys = [''] * 30
    values = [0] * 30
    keys[0] = '0'
    sizes = [[] for i in range(30)]
    ...
    keys[28] = '70-80'
    keys[29] = '80-90'
    usage_count = read_json(new_data_dir + "datas/s_3_2_1_data.txt")
    print(len(usage_count))
    for project_id in usage_count:
        size = proj_size[project_id]
        num = usage_count[project_id]
        if num > 80 and num <= 90:
            ...
            sizes[index].append(size)
    values[0] += 806 - len(usage_count)
    for pi in projs_3_month:
        if str(pi) not in usage_count:
            sizes[0].append(proj_size[str(pi)])
    new_sizes = []
    for entry in sizes:
        # print(entry)
        # print(np.mean(entry))
        # new_sizes.append(np.mean(entry) / 1000)
        new_sizes.append(np.median(entry))
    # for e in sizes:
    #     count += len(e)
    # print(count)
    draw_twinx(keys, values, new_sizes, "The Percent of a Project’s Methods That Call Library APIs (%)",
             "The Number of Projects (#)", "The Median Number of Libraries Used by a Project (#)")

def n_3_2_3():
    new_dic = {}
    version_dic = read_json(new_data_dir + "lib_percent.txt")
    count = 0
    for version in version_dic.keys():
        percent = version_dic[version]
        sql = "SELECT project_id,library_id FROM project_lib_usage WHERE version_id = " + version
        query_result = database.querydb(db, sql)
        length = 0
        library_id = None
        for entry in query_result:
            if entry[0] in projs_3_month:
                length += 1
                library_id = entry[1]
        if length <= 0:
            count += 1
    ...
    print(count) #4003
    print(new_dic)
    print(len(new_dic))#6496
    write_json(new_data_dir + "datas/s_3_2_3_data.txt", new_dic)
...
# n_3_2_1() #原来 7487
# n_3_2_3()
# data = read_json(new_data_dir + "datas/s_3_2_3_data.txt")
# print(len(data))
