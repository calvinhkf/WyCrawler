...
def s_4_2_2():
    ...
    # libs = read_json(new_data_dir + "datas/4_2_2_libs.txt")
    # usage_count = []
    # for id in libs:
    #     # print("++++++++++++++" + str(id))
    ...
    # print(usage_count)
    # print(len(usage_count))
    # write_json(new_data_dir +"datas/s_4_2_2.txt", usage_count)
    ...
    for id in libs:
        ...
        for entry in usage_info:
            ...
            if time_interval is not None:
                ...
                interval += time_interval
        if length > 0:
            usage_count[str(id)] = interval / length / 24
            # if interval / length / 24 > 4000:
            #     print("++++++++++++++" + str(id))
            #     print(interval / length / 24)
    # usage_count.sort()
    print(usage_count)
    print(len(usage_count))
    write_json(new_data_dir + "datas/s_4_2_2_data.txt", usage_count)
